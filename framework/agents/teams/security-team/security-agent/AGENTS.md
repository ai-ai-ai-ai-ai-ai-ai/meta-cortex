...
assignment from [Team Gizmo](../../gizmo/AGENTS.md).

- Read the consuming project's security requirements and affected code.
- For secret handling, apply the [common security skill](../../../../skills/security/security-skill/SKILL.md) and [secret lifecycle skill](skills/secret-lifecycle-skill/SKILL.md).
