...
[action ownership and typestate](rust-action-ownership.md).
...
- Narrow enum variants before reading their payloads.
  ...
  - Apply [decision locality](../../../../../../../skills/dev/coding-skill/practices/function-ownership.md#decision-locality)
