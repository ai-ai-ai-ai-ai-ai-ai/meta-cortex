---
name: local-feature
description: Manage local Git feature branches, isolated task worktrees, committed handoffs, integration, and safe cleanup. Use for local repository changes; excludes publishing and pull requests.
---
...
- Read [local feature integration](practices/local-feature-integration.md)
  before creating task worktrees, handing off commits, or integrating changes.
...
**Preferred:** return the validated local feature head. Perform publishing only
