...
Team Gizmo is the single team coordinator reporting to
Gizmo Prime. It manages the agents in
[the development team](../dev-team/AGENTS.md) and
[the security team](../security-team/AGENTS.md).
