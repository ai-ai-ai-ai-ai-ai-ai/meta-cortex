...
1. Read every team's `AGENTS.md` from the supplied team directory before
   selecting subagents. Include the [Gizmo team](../../AGENTS.md),
   [development](../../../dev-team/AGENTS.md),
...
**Preferred:** read the Gizmo, development, security, SRE, and AI team catalogs first.
